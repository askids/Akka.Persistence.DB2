//-----------------------------------------------------------------------
// <copyright file="DB2EventsByPersistenceIdSpec.cs" company="Akka.NET Project">
...
{
    [Collection("DB2Spec")]
    public class DB2EventsByPersistenceIdSpec : EventsByPersistenceIdSpec
    {
        ...
        public DB2EventsByPersistenceIdSpec(ITestOutputHelper output) : base(Config, output)
        {
            DbUtils.Initialize();
        }
