//-----------------------------------------------------------------------
// <copyright file="DB2EventsByTagSpec.cs" company="Akka.NET Project">
...
{
    [Collection("DB2Spec")]
    public class DB2EventsByTagSpec : EventsByTagSpec
    {
        ...
        public DB2EventsByTagSpec(ITestOutputHelper output) : base(Config, output)
        {
            DbUtils.Initialize();
        }
